...
plot = create_pplot {TITLE = "Просто линии",MARGINBOTTOM="35",AXS_YMIN=0,GRID="YES"}
plot:AddSeries({0,5,10},{1,6,8},{DS_MARKSTYLE="CIRCLE",DS_MODE="MARKLINE"})
plot:AddSeries({1,7,8},{2,3,9},{DS_MARKSTYLE="CIRCLE",DS_MODE="MARKLINE"})
plot:AddSeries({1,3,4},{1,2,9},{DS_MARKSTYLE="CIRCLE",DS_MODE="MARKLINE"})
plot:AddSeries({8,8,9},{1,3,6},{DS_MARKSTYLE="CIRCLE",DS_MODE="MARKLINE"})
plot:AddSeries({1,1,2},{3,7,9},{DS_MARKSTYLE="CIRCLE",DS_MODE="MARKLINE"})

plot2 = create_pplot {TITLE = "Просто линии",MARGINBOTTOM="35",AXS_YMIN=0,GRID="YES"}
plot2:AddSeries({0,5,10},{1,6,8},{DS_MARKSTYLE="CIRCLE",DS_MODE="MARKLINE"})
plot2:AddSeries({1,7,8},{2,3,9},{DS_MARKSTYLE="CIRCLE",DS_MODE="MARKLINE"})
