...
o_ptichi.othodi = 1
o_ptichi.cikl_videl = 12 -- через сколько циклов выделяет ГУМУС в почву
o_ptichi.d_videl = o_ptichi.cikl_videl -- сколько до следующего цикла выделения ГУМУСА
o_ptichi.zaderzhka_v_go = 4 -- сколько ждет циклов до следующего шага
