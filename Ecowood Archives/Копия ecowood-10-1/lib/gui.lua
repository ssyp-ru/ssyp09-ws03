...
function new() -- Начать новое наблюдение
	...
	o_d_cherv:create(math.random(1,g_h),math.random(1,g_w),math.random(0,223),math.random(0,223),math.random(0,223))
	o_d_cherv:create(math.random(1,g_h),math.random(1,g_w),math.random(0,223),math.random(0,223),math.random(0,223))
	o_datel:create(math.random(1,g_h),math.random(1,g_w),math.random(0,223),math.random(0,223),math.random(0,223))
